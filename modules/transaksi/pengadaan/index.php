...
$data_pengadaan = $db->fetchAll($query);

// Sidebar transaksi aktif jika di modul transaksi
...
<body>
    ...
    <nav class="navbar navbar-dark fixed-top">
        <div class="container-fluid">
            <span class="navbar-brand fw-bold"><i class="fas fa-shopping-cart me-2"></i>Data Pengadaan</span>
        ...
        <li class="nav-item">
            ...
            <div class="collapse<?= $isTransaksiActive ? ' show' : '' ?> ps-3" id="collapseTransaksi">
                <ul class="nav flex-column ms-2 mt-1">
                    ...
                    <li class="nav-item">
                        <a class="nav-link py-1" href="../penjualan/index.php">
    ...
    <div class="main-content">
        <div class="header-card">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                <div>
                    <h4 class="mb-1">
                        <i class="fas fa-shopping-cart me-2"></i>Data Pengadaan
                    </h4>
                    <p class="mb-0 text-white-75">Daftar seluruh transaksi pengadaan barang</p>
                </div>
                <a href="tambah.php" class="btn btn-light fw-semibold">
                    <i class="fas fa-plus me-1"></i> Tambah Pengadaan
                </a>
            </div>
        </div>
            ...
            <div class="card-body">
                <table class="table table-bordered table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <?php foreach ($data_pengadaan as $index => $row): ?>
                                <tr>
                                    <td><?= $index + 1 ?></td>
                                    ...
                                    <td class="text-center">
                                        <a href="detail.php?idpengadaan=<?= $row['idpengadaan'] ?>" class="btn btn-primary btn-sm mb-1">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="edit.php?idpengadaan=<?= $row['idpengadaan'] ?>" class="btn btn-warning btn-sm mb-1">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="delete.php?idpengadaan=<?= $row['idpengadaan'] ?>" class="btn btn-danger btn-sm"
