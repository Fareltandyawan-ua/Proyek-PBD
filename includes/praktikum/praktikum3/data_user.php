...
<body>
    ...
    <div class="content">
        ...
        <?php endif; ?>
        <button class="tambah-btn" onclick="window.location.href='tambah_user.php'">Tambah User</button>
        <table>
            <tr>
                <th>ID User</th>
                <th>Nama</th>
            ...
            <tr>
                ...
                <td>
                    <a class="aksi-link" href="edit_user.php?id=<?= $user->getIduser() ?>">Edit</a>
                    <a class="aksi-link" href="reset_password.php?id=<?= $user->getIduser() ?>">Reset Password</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
